  ...
  (setq-default
   ...
   '(lua
     ...
     (dart :variables
           ...
           dart-backend 'lsp
           ;; lsp-dart-sdk-dir "/usr/local/Caskroom/flutter/1.22.3/flutter/bin/cache/dart-sdk/"
...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-default-font '("FantasqueSansMono NF"
                               :size 11.0
                               :weight normal
                               :width normal)
   ...
   ;; (default nil)
   dotspacemacs-line-numbers '(t :relative nil
                                         :visual nil
                                         :disabled-for-modes dired-mode
                                         doc-view-mode
                                         markdown-mode
